...
static const std::string MC_UR3E_DESCRIPTION_PATH = "@MC_UR3E_DESCRIPTION_PATH@";
...
UR3eRobotModule::UR3eRobotModule() : mc_rbdyn::RobotModule(MC_UR3E_DESCRIPTION_PATH, "ur3e")
{
